...
import "github.com/JonatasMSantos/golang-apis-messaging-hexagonal-architecture/internal/entity"
...
func NewCreateProductUserCase(productRepository entity.ProductRepository) *CreateProductUseCase {
